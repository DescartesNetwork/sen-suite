      ...
      >
        <div className="grid grid-cols-12 gap-2">
          ...
          <p className="col-span-full">
            Lorem ipsum dolor sit amet, vim quodsi suscipiantur in. Ne vivendum
            appellantur, veri recteque usu ne. Ad quo tation ponderum, eu probo
            utamur aliquid has. Pro probo percipit eu.
          </p>
        </div>
      </Link>
      <Link
